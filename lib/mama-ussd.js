...
function MamaUssd() {
    ...
    // for (q=0;q<quiz_data.length;q++){
    //     quiz = quiz_data[q];
    //     self.add_creator(quiz_node, function(state_name, im) {
    //         question = quiz.quiz_details.questions[quiz["start"]];
    //         var choices = [];
    ...
    //     answer = quiz.quiz_details.answers[state_name];
    //     return new ChoiceState(
    //         state_name,
    //         function(choice){ return choice.value; },
    //         answer.response,

...
function MamaUssd() {
    ...
    self.add_creator('register_prebirth_2', function(state_name, im) {
        var choices = [];
        choices[0] = new Choice("1", "Jan");
        choices[1] = new Choice("2", "Feb");
        choices[2] = new Choice("3", "March");
        choices[3] = new Choice("4", "April");
        choices[4] = new Choice("5", "May");
        choices[5] = new Choice("6", "June");
        choices[6] = new Choice("7", "July");
        choices[7] = new Choice("8", "Aug");
        choices[8] = new Choice("9", "Sept");
    ...
    self.add_creator('register_all_hivinfo', function(state_name, im) {
        if (im.get_user_answer('register_all_1') == "pregnant") {
            ...
            var preg_week = self.calc_weeks(new Date(),due_month);
        } else {

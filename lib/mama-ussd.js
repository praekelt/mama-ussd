...
function MamaUssd() {
    ...
    self.on_config_read = function(event){
        ...
        for (var quiz_name in im.config.quiz_data){
            ...
            // Create the quiz
            console.log("creating quiz data:", quiz_name);
            for (var question_name in quiz.quiz_details.questions){
                console.log("creating question node:", quiz_name+"_"+question_name);
                var question = quiz.quiz_details.questions[question_name];
                self.add_creator(quiz_name+"_"+question_name, function(state_name, im) {
                    var choices = [];
            ...
            for (var answer_name in quiz.quiz_details.answers){
                console.log("creating answer node:", quiz_name+"_"+answer_name);
                var answer = quiz.quiz_details.answers[answer_name];
                self.add_creator(quiz_name+"_"+answer_name, function(state_name, im) {
                    return new ChoiceState(
